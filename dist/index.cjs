...
var tld = require('tldts');
var path = require('path');
var pkg = require('micromatch');
...
var tld__namespace = /*#__PURE__*/_interopNamespaceDefault(tld);
...
class ParsedUrl extends URL {
  ...
  get isIp() {
    return !!tld__namespace.parse(this.href).isIp;
  }
  get isIcann() {
    return !!tld__namespace.parse(this.href).isIcann;
  }
  get isPrivate() {
    return !!tld__namespace.parse(this.href).isPrivate;
  }
  get properties() {
...
Object.defineProperty(exports, "URLPattern", {
  enumerable: true,
  get: function () { return urlpatternPolyfill.URLPattern; }
});
exports.NormalizedUrl = NormalizedUrl;
